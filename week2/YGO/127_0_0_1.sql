...
-- 数据库： `ygo`
--
CREATE DATABASE IF NOT EXISTS `ygo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `ygo`;
...
INSERT INTO `diyygocard` (`Card_Name`, `primary_type`, `secondary_type`, `attribute`, `race`, `level`, `rank`, `link`, `effect_type`, `attack`, `defense`, `number`) VALUES
('迎击之都拔斗士优特雷西德', 'monster', 'XYZmonster', 'dark', 'warrior', 0, 4, 0, 'blockade_summons', 2400, 1800, 1),
('迎击之都拔斗士杰达鲁修巴鲁卡', 'monster', 'XYZmonster', 'dark', 'warrior', 0, 4, 0, 'increase_attack', 2500, 1900, 2),
('迎击之都拔斗士由娜奇夏艾', 'monster', 'XYZmonster', 'wind', 'beastwarrior', 0, 4, 0, 'interrupt', 2200, 1800, 3),
('迎击之都拔斗士米库莉洛奇', 'monster', 'XYZmonster', 'dark', 'spellcaster', 0, 4, 0, 'destruction', 2600, 0, 4),
('迎击之都拔斗士萝查莉多西芙涅鲁', 'monster', 'XYZmonster', 'fire', 'beastwarrior', 0, 4, 0, 'search', 2200, 1800, 5),
('迎击之都魔族雹哭魔神芙露蕾蒂', 'monster', 'XYZmonster', 'dark', 'demon', 0, 8, 0, 'interrupt', 3000, 2500, 6);
...
(7, 'Squirtle', '[\'Torrent\', \'Rain Dish\']', 'Tiny Turtle Pokemon', 48, 65, 44, 43, 'water', '', '0.50', '9.00', 1, 0, 'icons/7.png'),
(8, 'Wartortle', '[\'Torrent\', \'Rain Dish\']', 'Turtle Pokemon', 63, 80, 59, 58, 'water', '', '1.00', '22.50', 1, 0, 'icons/8.png'),
(9, 'Blastoise', '[\'Torrent\', \'Rain Dish\']', 'Shellfish Pokemon', 103, 120, 79, 78, 'water', '', '1.60', '85.50', 1, 0, 'icons/9.png'),
...
(13, 'Weedle', '[\'Shield Dust\', \'Run Away\']', 'Hairy Pokemon', 35, 30, 40, 50, 'bug', 'poison', '0.30', '3.20', 1, 0, 'icons/13.png'),
...
(25, 'Pikachu', '[\'Static\', \'Lightningrod\']', 'Mouse Pokemon', 55, 40, 35, 90, 'electric', '', '0.40', '6.00', 1, 0, 'icons/25.png'),
...
(52, 'Meowth', '[\'Pickup\', \'Technician\', \'Unnerve\', \'Pickup\', \'Technician\', \'Rattled\']', 'Scratch Cat Pokemon', 35, 35, 40, 90, 'normal', 'dark', '0.40', '4.20', 1, 0, 'icons/52.png'),
...
(150, 'Mewtwo', '[\'Pressure\', \'Unnerve\']', 'Genetic Pokemon', 150, 70, 106, 140, 'psychic', '', '2.00', '122.00', 1, 1, 'icons/150.png'),
(151, 'Mew', '[\'Synchronize\']', 'New Species Pokemon', 100, 100, 100, 100, 'psychic', '', '0.40', '4.00', 1, 1, 'icons/151.png');
